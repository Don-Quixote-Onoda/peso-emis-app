...
// Function to count the number of hired applicants by date_hired
...
// Function to count the number of hired applicants by week and is_hired
...
// Function to count the number of hired applicants by month and is_hired
...
for ($month = 1; $month <= 12; $month++) {
    ...
    foreach ($period as $date) {
        ...
        // Get the number of hired applicants for the current day
        $count = getHiredApplicantsByDate($date->format('Y-m-d'));

        // Add the day and its hired applicants count to the current week array
        $dayArray = [
            'day' => $date->format('M j'),
