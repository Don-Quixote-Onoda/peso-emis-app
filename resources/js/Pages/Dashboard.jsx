...
export default function Dashboard(props) {
    ...
    useEffect(() => {
        if (props.auth.user.role == 0) {
            fetchEmployerJobPosting(props.auth.user);
        }
    ...
    const showEmployerPostingDetails = (cardData) => {
        ...
        props.auth.user.role === 1
            ? fetchEmployerJobPosting(cardData)
            : fetchMatchingApplicants(cardData);
    };
    ...
    return props.auth.user.is_activated == 1 || props.auth.user.role == 1 ? (
        <AuthenticatedLayout
            auth={props.auth}
            errors={props.errors}
            header={
        ...
        >
                        ...
                        <div className=" overflow-hidden shadow-sm sm:rounded-lg">
                            ...
                            {type == "show_applicants" && (
                                <>
                                    ...
                                    />
                                    <Applicants
                                        applicants={applicantMatches}
                                        setDashBoardType={setType}
                                        auth={props.auth}
                                        isMatches={true}
                                    />
                                </>
            ...
            {props.auth.user.role == 0 && jobPosts && (
                <div className="py-12">
                    <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div className=" overflow-hidden shadow-sm sm:rounded-lg">
                            {type == "default" && (
