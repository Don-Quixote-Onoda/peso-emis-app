...
export default function ViewApplicant({ applicant, back }) {
    ...
    const handlePrintApplicant = (e) => {
        ...
        let input = window.document.getElementsByClassName("printApplicant")[0];
        ...
        <>
            <div className="flex gap-3 justify-end mb-3">
                <Button
                    ...
                    onClick={(e) => handlePrintApplicant(e)}
                />
                <Button
            ...
            <div className="printApplicant">
                ...
                <div class="step-3">
                    <div class="py-5 card p-3 border-0 rounded-0">
                        <h4 class="card-header bg-white  pl-0 border-0 fw-bold">
                            2. Job Preference{" "}
                        </h4>
                ...
                <div class="step-6">
                    <div class="pt-5 card p-3 border-0 rounded-0">
                        <h4 class="card-header  bg-white pl-0 border-0 fw-bold">
                ...
                <div class="step-7">
                    <div class="pb-5 card p-3 border-0 rounded-0">
                        <h4 class="card-header bg-white  pl-0 border-0 fw-bold">
                ...
                <div class="step-10">
                    <div class="py-5 card p-3 border-0 rounded-0">
                        <h4 class="card-header bg-white  pl-0 border-0 text-center fw-bold">
