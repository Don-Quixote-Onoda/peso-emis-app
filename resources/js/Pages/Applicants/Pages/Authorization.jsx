...
export default function Authorization({
    ...
    const personalInformation = {
        personalDetails: {
            ...
            activelyLookingForWork: sessionStorage.getItem(
                "activelyLookingForWork"
            ),
            howLongLookingForWork: sessionStorage.getItem(
                "howLongLookingForWork"
            ),
            noWhenToWork: sessionStorage.getItem("noWhenToWork"),
            willingToWorkImmediately: sessionStorage.getItem(
        ...
        educationalBackground: {
            elementary: {
                ...
                underGraduate: sessionStorage.getItem(
                    "undergraduateLevelElementary"
                ),
                awardsRecieved: sessionStorage.getItem(
                    "awardsRecievedElementary"
                ),
                yearLastAttended: sessionStorage.getItem(
            ...
            graduateStudies: {
                ...
                yearGraduated: sessionStorage.getItem(
        ...
        trainingVocationalCourse: {
            trainingVocationalCourse1: {
                training_or_courses: sessionStorage.getItem(
                    "trainingVocationalCourse1"
                ),
                duration: sessionStorage.getItem(
                    "trainingVocationalCourseDuration1"
                ),
                instituition: sessionStorage.getItem(
                    "trainingVocationalCourseTrainingInstituition1"
                ),
                certificates: sessionStorage.getItem(
        ...
        eligibility: {
            eligibility1: {
                ...
                date_of_examination: sessionStorage.getItem(
        ...
        professionalLicense: {
            professional_license1: {
                professionalLicense: sessionStorage.getItem(
                    "professionalLicense1"
                ),
                valid_until: sessionStorage.getItem(
        ...
        jobPreferenceLocation: {
            preferredOccupation1: sessionStorage.getItem(
                "preferredOccupation1"
            ),
            preferredOccupation2: sessionStorage.getItem(
                "preferredOccupation2"
            ),
            preferredOccupation3: sessionStorage.getItem(
                "preferredOccupation3"
            ),
            preferredOccupation4: sessionStorage.getItem(
                "preferredOccupation4"
            ),
        },
        preferredWorkLocation: {
            local: {
                preferredWorkLocationLocal1: sessionStorage.getItem(
                    "preferredWorkLocationLocal1"
                ),
                preferredWorkLocationLocal2: sessionStorage.getItem(
                    "preferredWorkLocationLocal2"
                ),
                preferredWorkLocationLocal3: sessionStorage.getItem(
                    "preferredWorkLocationLocal3"
                ),
            },
            overseas: {
                preferredWorkLocationOverseas1: sessionStorage.getItem(
                    "preferredWorkLocationOverseas1"
                ),
                preferredWorkLocationOverseas2: sessionStorage.getItem(
                    "preferredWorkLocationOverseas2"
                ),
                preferredWorkLocationOverseas3: sessionStorage.getItem(
        ...
        employment: {
            ...
            unemployed: {
                unemployementStatus: 1,
                unemployementStatusType:
